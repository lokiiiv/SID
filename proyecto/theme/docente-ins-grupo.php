               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="hero">
                        ...
                        <!-- para -->
                        <p style="font-size:2em">---Instrumentaciones Grupo X---</p>
                     </div>
                        ...
                        <div class="tabbable tabs-left">
                          ...
                          <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#tab1" data-toggle="tab">Alumno 1</a></li>
                            <li><a href="#tab2" data-toggle="tab">Alumno 2</a></li>
                            <li><a href="#tab3" data-toggle="tab">Alumno 3</a></li>
                          </ul>
