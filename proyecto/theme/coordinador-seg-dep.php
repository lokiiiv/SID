   ...
   <div class="container">
               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     ...
                     <div class="hero">
                        ...
                        <h2 style="font-size:3em"><span>Coordinador</span></h2>
                        <!-- para -->
                        <p style="font-size:2em">---Calendario de Instrumentación didáctica---</p>
                     </div>
                     <!-- Review -->
                     
                     <!-- Review list. Note down the class name before editing. -->
                     <div class="row">
                        <div class="col-md-16 col-sm-16">
                           <div class="review" >
                              ...
                              <div class="rgood" style="margin-left:0px">
                                 <h2><i class="" ></i> Periodo</h2>
                                 <!-- Periodo -->
                              ...
                              <div class="rbad" style="">
                                 <h2><i class=""></i> Fecha</h2>
                                 
                                 <!-- Fecha -->
                                 
                               <div align="center"><iframe src="fecha.html" width=99% height=400 frameborder=1 
    style="border:solid #003b4a 2px; margin-bottom:5%;"></iframe></div> 
            ...
            <div class="cta">
               <div class="row">
                  <div class="col-md-15">	
                     <div class="button"><a href="#">Guardar</a></div>
                  </div>
