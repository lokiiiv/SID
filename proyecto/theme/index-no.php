		   ...
		   <div class="container">
			  <div class="row">
				 <div class="col-md-4 col-sm-4">
					<!-- Logo and site link -->
					<div class="logo">
					   <h1><a href="index.html">Instrumentaciones Didácticas<span class="color">.</span></a></h1>
					</div>
				 </div>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="docente-ins.php">Instrumentaciones</a></li>
								<li><a href="docente-grupos">Grupos</a></li>
								
							</ul>
						</li>   
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Precidente GA <b class="caret"></b></a>
							<!-- Submenus -->
							<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Precidente academia<b class="caret"></b></a>
							<!-- Submenus -->
							<ul class="dropdown-menu">
								<li><a href="">.</a></li>
						...
						<li class="dropdown">
							...
							<!-- Submenus -->
							<ul class="dropdown-menu">
								<li><a href="coordinador-seg-dep.php">Seguimiento departamental</a></li>
								<li><a href="coordinador-asig.php">Habilitar asignaturas</a></li>
								<li><a href="coordinador-asig-mat.php">Asignar materias</a></li>
                                <li><a href="">Seleccionar docentes</a></li>
							</ul>
						</li>   
						<li class="dropdown">
                        ...
                        <li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Sesión <b class="caret"></b></a>
							<!-- Submenus -->
							<ul class="dropdown-menu">
						...
						<ul>	<!-- SLIDE  -->
							<li data-transition="flyin" data-slotamount="4" data-masterspeed="300">
								...
								<div class="tp-caption modern_big_redbg skewfromleftshort customout"
									...
									style="z-index: 1">Latest Ver 4.0
								</div>
								<!-- LAYER NR. 1.1 -->
								...
								<div class="tp-caption medium_text lfl paragraph"
									...
									data-endspeed="300"
									style="z-index: 2">Lorem ipsum consectetur dolor sit amet, consectetur attses<br />sicing elit, sed dounde consectetur omnis eiusmod incidi<br />aliqua Ut enim ad minim veniam!
								</div>
								<!-- LAYER NR. 3 -->
								<div class="tp-caption sfb"
									...
									data-easing="Circ.easeOut"
									data-endspeed="300"
									style="z-index: 3"><a class="btn btn-danger hidden-xs" href="#">Get Features</a>
								</div><!-- LAYERS NR. 4 -->
								<div class="tp-caption lfr"
									...
									style="z-index: 4"><img src="img/slider/s11.png" class="img-responsive" alt="" />
								</div>
							...
							<li data-transition="cube" data-slotamount="6" data-masterspeed="300">
								...
								<div class="tp-caption medium_text customin customout paragraph"
									...
									data-endeasing="Power4.easeIn"
									data-captionhidden="on"
									style="z-index: 9">Lorem ipsum dolor sit amet, consectetur adipi<br />sicing elit, sed do eiusmod tempor incidi<br />aliqua Ut enim ad minim veniam!
								</div>
								<!-- LAYERS NR. 7 -->
								<div class="tp-caption lfr"
									...
									data-endeasing="Linear.easeNone"
									data-captionhidden="off"
									style="z-index: 12"><img src="img/slider/s21.png" class="img-responsive" alt="" />
								</div>
								<!-- LAYERS NR. 8 -->
								<div class="tp-caption lfr"
									...
									data-endeasing="Linear.easeNone"
									data-captionhidden="off"
									style="z-index: 13"><img src="img/slider/s23.png" class="img-responsive" alt="" />
								</div>
								<!-- LAYERS NR. 9 -->
								<div class="tp-caption lfr"
									...
									data-endeasing="Linear.easeNone"
									data-captionhidden="off"
									style="z-index: 14"><img src="img/slider/s24.png" class="img-responsive" alt="" />
								</div>
							</li>
						</ul>
					</div>
