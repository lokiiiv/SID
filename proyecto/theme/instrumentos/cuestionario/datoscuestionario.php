...
<body>
	...
	<div class="container" style="width: 100%;">
		<!–– primer encabezado ––>
			...
			<script>
				...
				$("#agregar2").click(function() {
					if ($("#mps")[0].value == "" || $("#mps")[0].value == "0") {
						...
						var texto3 = '<div class="row mt-2"><div class="col-lg-12 col-sm-12 col-md-12"><div class="form-group" style="text-align: left;"> Ingrese las respuestas y elija la o las respuestas correctas. </div></div></div>';
						var n = $("#mps")[0].value;
						...
						texto = '<div class="col-lg-12 col-sm-12 col-md-12 mb-4 conte-subrayar">' +
							'<div class="row">' +
							'<div class="col-lg-12 col-sm-12 col-md-12">' +
							'<div class="form-group" style="text-align: left;">' +
							'<hr style="height:1px; width: 100%; border-style:dotted;  background-color: black;">' +
							'<p>Ingrese la pregunta, el puntaje y en caso de que sea de alcance, elija tipo de indicador.</p>' +
							'</div>' +
							'</div>' +
							'</div>' +
							'<div class="row">' +
			...
			<script>
				function botonecs(c) {
					var contenedor = c.closest(".conte-subrayar").remove();
					//Obtener el div con id minimos2 para obtener la cantidad su cantidad de divs
					if (document.getElementById("minimos2").children.length == 0) {
				...
				$.post("conexion/consultasNoSQL.php", parametros, function(x) {
					if (x != "") {
						...
						for (var ii = 0; ii < prel.length; ii++) {
							...
							var texto = '<div class="col-lg-12 col-sm-12 col-md-12 mb-4 conte-subrayar">' + 
										'<div class="row">' +
											'<div class="col-lg-12 col-sm-12 col-md-12">' +
												'<div class="form-group" style="text-align: left;">' +
													'<hr style="height:1px; width: 100%; border-style:dotted;  background-color: black;">' + 
			...
			<script>
				$("#leerexcel").click(function(data) {
					...
					const respuesta = fetch("instrumentos/cuestionario/subeexcel.php", {
						...
						//alert("ok");
						$.post("instrumentos/cuestionario/leeexcelA.php", {
							ia: '<?php echo $INDALC; ?>'
						}, function(values) {
							var v = values.split("**********");
							//alert(v.length);
