                      ...
                      Note down the below markup. -->
                        ...
                        <div class="panel">
                          ...
                          <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                              ...
                              <!--row  -->
                              <div class="row">
                                <div class="col-md-3 azul" id="columna"><h4>Documento <span class="color" id="campoDocumento"></span></h4> </div>
                                <div class="col-md-6 azul" id="columna"><h4>Cláusula ISO 9001 2008 <span class="color" id="campoClausula"></span></h4></div>
                                <div class="col-md-3 azul" id="columna"><h4>Revisión <span class="color" id="campoRevision"></span></h4></div>
                              </div><!--Fin row -->
                              
                              <!--row -->
                              <div class="row">
                                <div class="col-md-3 azul" id="columna"><h4>Responsable <span class="color" id="campoResponsable"></span></h4> </div>
                                <div class="col-md-6 azul" id="columna"><h4>Fecha de emisión <span class="color" id="campoFechaEmision"></span></h4></div>
                                <div class="col-md-3 azul" id="columna"><h4>Código del documento <span class="color" id="campoCodigoDocumento"></span></h4></div>
                              </div><!--Fin row-->
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 azul" id="columna">
                                  ...
                                  <!-- Select box -->
                                  <div class="form-group">
                                    <label class="control-label col-md-3" for="select"><h4>Plan de estudios:</h4></label>
                                    <div class="col-md-9" >                               
                              ...
                              <!--row -->
                              <div class="row">
                                <div class="col-md-3 azul" id="columna"><h4>Nombre de la asignatura: <span class="color" id="campoMateria"></span></h4></div>
                                <div class="col-md-3 azul" id="columna"><h4>Clave de la asignatura: <span class="color" id="campoClaveAsignatura"></span></h4></div>
                                <div class="col-md-3 azul" id="columna"><h4>Créditos: <input width="40px" class="color text-center" id="campoCreditos"></h4></div>
                                <div class="col-md-2 azul" id="columna"><h4>Número de Tema: <span class="color" id="campoTemas">[Seleccione un tema]</span></h4></div>
                              </div><!--Fin row -->
                              <!--row -->
                              <div class="row">
                                <div class="col-md-3 azul" id="columna"><h4>Semestre: <span class="color" id="campoSemestre"></span></h4></div>
                                <div class="col-md-4 azul" id="columna"><h4>Clave de grupo: <span class="color" id="campoGrupo"><?php echo $_GET["grupo"] ?></span></h4></div>
                                <div class="col-md-5 azul" id="columna">
                                    <label class="control-label" for="select"><h4>Periodo: <span class="color" id="campoPeriodo"><?php echo $_GET["p"] ?></span></h4></label>
                        ...
                        <div class="panel">
                          ...
                          <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                              <div class="mostrarContenido"><p id="Caracterizacion"></p></div>                 
                        ...
                        <div class="panel">
                          ...
                          <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                              <div class="mostrarContenido"><p id="IntencionDidactica"></p></div>
                        ...
                        <div class="panel">
                          ...
                          <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                              <div class="mostrarContenido"><p id="CompetenciasPrevias"></p></div>
                              <!-- Modal -->
                              <!-- Trigger the modal with a button -->
                        ...
                        <div class="panel">
                          ...
                          <div id="collapseFive" class="panel-collapse collapse">
                            <div class="panel-body">
                            <div class="mostrarContenido"><p id="CompetenciaEA"></p></div>
                            <!-- Modal -->
                            ...
                            <div id="myModal4" class="modal fade" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body"><p><textarea  style="width:100%; height:30em" id="campoCompetenciaEA"></textarea></p>
                                  </div>
                                  <div class="modal-footer">
                        ...
                        <div class="panel" id="panelCompetenciaET">
                          ...
                          <div id="collapseSix" class="panel-collapse collapse">
                            <div class="panel-body">
                              ...
                              <div class="row">
                              <p><h4>Tema: <input id="TituloTema"></h4> <h4 id="estatusTituloTema"></h4>
                              ...
                              <div class="mostrarContenido"><p id="CompetenciaET"></p></div>
                              <!-- Modal -->
                              ...
                              <div id="myModal5" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p><textarea  style="width:100%; height:30em" id="campoCompetenciaET"></textarea></p>
                                    </div>
                                    <div class="modal-footer">
                              ...
                              <div class="mostrarContenido"><p id="CompetenciasGen"></p></div>
                              <!-- Modal -->
                              ...
                              <div id="myModal51" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p><textarea  style="width:100%; height:30em" id="campoCompetenciasGen"></textarea></p>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div class="panel" id="panelProcesoEA">
                          ...
                          <div id="collapseSeven" class="panel-collapse collapse">
                            <div class="panel-body">
                              ...
                              <div class="mostrarContenido"><p id="TemasSubtemas"></p></div>
                              ...
                              <div id="myModalTemas" class="modal fade" role="dialog">
                                <div class="modal-dialog"> 
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p><textarea  style="width:100%; height:20em" id="campoTemasSubtemas"></textarea></p>
                                    </div>
                                    <div class="modal-footer">
                              ...
                              <table class="table table-hover" id="tablaActividades">
                                <thead>
                                  <tr>
                                    <th> <h4> Actividades de enseñanza (Docente) </h4></th>
                                    <th> <h4> Actividades de aprendizaje (Estudiante) </h4></th>   
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr>
                             ...
                             <div class="dividerM" style="margin-bottom: 5px"></div>
                              ...
                              <div class="mostrarContenido"><p id="HTP"></p></div>
                              ...
                              <div id="myModalHTP" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p><textarea  style="width:100%; height:20em" id="campoHTP"></textarea></p>
                                    </div>
                                    <div class="modal-footer">
                                      <h4 id="estatusHTP"></h4>
                            ...
                            <!-- Termina Héctor -->
                             ...
                             <div class="dividerM" style="margin-bottom: 5px"></div>
                              ...
                              <div class="mostrarContenido"><p id="Recursos"></p></div>
                              ...
                              <div id="myModalRecursos" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p><textarea  style="width:100%; height:20em" id="campoRecursos"></textarea></p>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div class="panel" id="panelIndicadores">
                          ...
                          <div id="collapseTen" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <div class="mostrarContenido"><p id="Indicadores"></p></div>
                                <!-- Modal -->
                                ...
                                <div id="myModal10" class="modal fade" role="dialog">
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body"><p><textarea  style="width:100%; height:30em" id="campoIndicadores"></textarea></p>
                                      </div>
                                      <div class="modal-footer">
                              ...
                              <table class="table table-hover text-justify">
                                ...
                                <tbody>
                                  <tr >
                                    ...
                                    <td align="center"><div style="width:60%;"><strong><input readonly class="form-control text-center" value="0" type="number" min="0" id="numA" onchange="sumar()"></strong></div></td>
                                  </tr>
                                  <tr>
                                    <td class="text-center"><strong>B</strong></td>
                                    <td>Hace aportaciones a las actividades académicas desarrolladas</td>
                                    <td align="center"><div style="width:60%;"><strong><input  readonly class="form-control text-center" value="0" type="number" min="0" id="numB" onchange="sumar()"></strong></div></td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td align="center"><div style="width:60%;"><strong><input readonly class="form-control text-center" value="0" type="number" min="0" id="numC" onchange="sumar()"></strong></div></td>
                                  </tr>
                                  <tr>
                                    <td class="text-center"><strong>D</strong></td>
                                    <td>Introduce recursos y experiencias que promueven un pensamiento crítico</td>
                                    <td align="center"><div style="width:60%;"><strong><input readonly class="form-control text-center" value="0" type="number" min="0" id="numD" onchange="sumar()"></strong></div></td>
                                  </tr>
                                  <tr>
                                    <td class="text-center"><strong>E</strong></td>
                                    <td>Incorpora conocimientos y actividades interdisciplinarias en su aprendizaje</td>
                                    <td align="center"><div style="width:60%;"><strong><input readonly class="form-control text-center" value="0" type="number" min="0" id="numE" onchange="sumar()"></strong></div></td>
                                  </tr>
                                  <tr>
                                    <td class="text-center"><strong>F</strong></td>
                                    <td>Realiza su trabajo de manera autónoma y autorregulada</td>
                                    <td align="center"><div style="width:60%;"><strong><input readonly class="form-control text-center" value="0" type="number" min="0" id="numF" onchange="sumar()"></strong></div></td>                                    
                                  </tr>
                                  <tr>
                                    <td></td>
                                    <td></td>
                                    <td align="center">TOTAL: <strong><p id="totalIndicadores">0</p></strong></td>
                                  </tr>
                                </tbody>
                              </table>
                                  ...
                                  <table id="matrizEvaluacion" class="table table-hover text-justify">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td><strong><p id="totalPerc">0</p></strong></td>
                                        <td id="totalA">0</td>
                                        <td id="totalB">0</td>
                                        <td id="totalC">0</td>
                                        <td id="totalD">0</td>
  ...
  function copiarsemanas(boton){
    alertify.confirm("<h3>¿Deseas pasar estos datos a tu calendarización?</h3>Después de pasar los datos, debes hacer clic en guardar",function(){
      ...
      alertify.success("<h3>Se copió con éxito, si deseas conservar estos cambios en tu calendarización, debes hacer clic en guardar</h3>",7);
                                ...
                                <table id="tablaFechas" class="table table-hover">
                                  ...
                                  <tbody id="cuerpoTablafechas">
                                    ...
                                    <tr>
                                      ...
                                      <td><h3 id="calendarClaveGrupo"><?php echo $sines; ?></h3></td>
                              ...
                              <div class="row">
                                <div class="col-md-3 azul" id="columna"><h5>SD <span class="color">Seguimiento departamental</span></h5> </div>
                                <div class="col-md-3 azul" id="columna"><h5>ED <span class="color">Evaluación diagnóstica</span></h5> </div>
                                <div class="col-md-3 azul" id="columna"><h5>Efn <span class="color">Evaluación formativa (competencia específica)</span></h5> </div>
                                <div class="col-md-3 azul" id="columna"><h5>ES <span class="color">Evaluación sumativa</span></h5> </div>
                              </div>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover" id="tablaFuentes">                     
                                  <thead>
                                    <tr>
                                      <th> <h3> No.</h3></th>
                                      <th class="text-center"> <h3> Fuente de Información</h3></th>
                                      <td> 
                                ...
                                <div id="myModalFuentes" class="modal fade" role="dialog">
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body"><p><textarea  style="width:100%; height:30em; font-size: 11px" id="campoFuentes"></textarea></p>
                                      </div>
                                      <div class="modal-footer">
      ...
      <script>
        ...
        function abreinstrumento(cual){
          ...
          if(instrumento=="Guía de observación"){
            ...
            $("#instrumentos").load("instrumentos/guiaobservacion/datosguia.php",{evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,instrug:instrug},function(res){
              //alert(res);
            ...
            $("#instrumentos").load("instrumentos/listacotejo/datoslista.php",{evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,instrug:instrug},function(res){
              //alert(res);

            });
          }else if(instrumento=="Cuestionario"){
            $("#exampleModalLabel")[0].innerHTML="CUESTIONARIO";
            $("#instrumentos").load("instrumentos/cuestionario/datoscuestionario.php",{evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,instrug:instrug},function(res){
              //alert(res);
            ...
            $("#instrumentos").load("instrumentos/rubrica/datosrubrica.php",{evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,instrug:instrug},function(res){
              //alert(res);
      ...
      <script>  
        function VerinstrumentoLista(){
          ...
          if (tm.length==0) {
            ...
            $("#instrumentos").load("instrumentos/listacotejo/lista.php",{CS:CS,PE:PE,evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,fa:fa,te:te,CoT:ComT,taa:taa,tma:tma,PRCDMTL:procedimental,CNCPTL:conceptual,CTTDNL:actitudinal}, function(){
        ...
        $("#ver").click(function(){
          ...
          alertify.confirm("<h4>Si realizó alguna modificación y no gardó, perderá los cambios, desea continuar</h4>",
            ...
            ,function(){alertify.success("De clic en el botón de guardar",5);
          });
...
//alert("ok");
          ...
          //alert(CTema);
          $("#instrumentos").load("instrumentos/rubrica/rubrica.php",{CTema:CTema,CS:CS,PE:PE,evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,fa:fa,te:te,CoT:ComT,PRCDMTL:procedimental,CNCPTL:conceptual,CTTDNL:actitudinal,general:general},function(){
        ...
        function VerinstrumentoGuia(){
          ...
          if (ban1 && ban2) {
            ...
            $("#instrumentos").load("instrumentos/guiaobservacion/guia.php",{CS:CS,PE:PE,evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,fa:fa,te:te,CoT:ComT,PRCDMTL:procedimental,CNCPTL:conceptual,CTTDNL:actitudinal,general:general},function(){
        ...
        function verinstrumentoCuestionario(){
          ...
          if (contmin1<1 || contmin2<1 || contmin3<1) {
            ...
            $("#instrumentos").load("instrumentos/cuestionario/cuestionario.php",{CS:CS,PE:PE,evi:evidencia, ins:instrumento, num:cual,per:periodo,A:A,B:B,C:C,D:D,E:E,F:F,por:por,mat:materia,gru:grupo,tem:tem,fa:fa,te:te,CoT:ComT,PRCDMTL:procedimental,CNCPTL:conceptual,CTTDNL:actitudinal,listapr:listapr,listasb2:listasb2, listapvf:listapvf}, function(){
