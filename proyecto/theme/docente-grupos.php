				...
				<!-- Navigation links starts here -->
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<!-- Submenus -->
							<ul class="dropdown-menu">
								<li><a href="">Seguimiento departamental</a></li>
								<li><a href="">Habilitar asignaturas</a></li>
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="hero">
                        ...
                        <h2 style="font-size:3em"><span>Docente</span></h2>
                        <!-- para -->
                        <p style="font-size:2em">---Grupos---</p>
                     </div>
                     <!-- Pricing table -->
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="price-a pricel center">
                                 ...
                                 <div class="phead-bottom">
                                    ...
                                    <p><span class="pst"></span>Nombre-Materia<span class="psb"></span></p>
                                    <p><span class="pst"></span>Horario<span class="psb"></span></p>
                                 </div>
                                 <div class="arrow-down"></div>
                              <div class="plist">
                                 <!-- List -->
                                 <ul>
                                    <li>Lunes: 00:00 -00:00 (Salon x)</li>
                                    <li>Martes: 00:00 -00:00 (Salon x)</li>
                                    <li>Miercoles: 00:00 -00:00 (Salon x)</li>
                                    <li>Jueves: 00:00 -00:00 (Salon x)</li>
                                    <li>Viernes: 00:00 -00:00 (Salon x)</li>
                                 </ul>
                              </div>
                              <div class="pbutton">  
                                 <!-- button -->
                                 <div class="button"><a href="docente-ins-grupo.php"><i ></i> Intrumentaciones</a></div>
                              </div>
                           </div>
                           ...
                           <div class="price-b pricel center phighlight">
                              ...
                              <div class="pbutton">  
                                 <!-- button -->
                                 <div class="button"><a href="#"><i ></i> Intrumentaciones</a></div>
                              </div>                           </div>   
