...
<table align="center" cellspacing="0" border="0" style="width: 90%;">
	...
	<tr>
		...
		<td style="border-bottom: 1px solid #1f497d" colspan=6 align="center" valign=middle><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->Documento)) echo $instrumentacion->Documento; ?><br></font></b></td>
		<td colspan=5 align="center" valign=middle bgcolor="#C6D9F1"><b><font size=1>CLÁUSULA ISO 9001 2008</font></b></td>
		<td style="border-bottom: 1px solid #1f497d" colspan=4 align="center" valign=middle><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->Clausula)) echo $instrumentacion->Clausula; ?><br></font></b></td>
		<td colspan=4 align="center" valign=middle bgcolor="#C6D9F1"><b><font size=1>REVISIÓN</font></b></td>
		<td style="border-bottom: 1px solid #000000" align="center" valign=middle><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->Revision)) echo $instrumentacion->Revision; ?><br></font></b></td>
	...
	<tr>
		...
		<td colspan=6 style="border-bottom: 1px solid #1f497d" align="center" valign=middle><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->Responsable)) echo $instrumentacion->Responsable; ?><br></font></b></td>
		
		<td colspan=5 align="center" valign=middle bgcolor="#C6D9F1"><b><font size=1>FECHA DE EMISIÓN</font></b></td>
		<td style="border-bottom: 1px solid #1f497d" colspan=4 align="center" valign=middle sdnum="2058;0;@"><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->FechaEmision)) echo $instrumentacion->FechaEmision; ?><br></font></b></td>
		<td colspan=4 align="center" valign=middle bgcolor="#C6D9F1"><b><font size=1>CÓDIGO DEL DOCUMENTO</font></b></td>
		<td style="border-bottom: 1px solid #000000" colspan=3 align="center" valign=middle><b><font face="Arial Narrow"><?php  if(isset($instrumentacion->CodigoDocumento)) echo $instrumentacion->CodigoDocumento; ?><br></font></b></td>
		<td align="left" valign=middle><font face="Arial Narrow"><br></font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="border-top: 3px solid #ffffff; border-bottom: 3px solid #ffffff" colspan=2 align="center" valign=middle bgcolor="#F1F5F9"><i><font size=3><?php  if(isset($grupo1)) echo $grupo1; ?><br></font></i></td>
		<td style="border-top: 3px solid #ffffff; border-bottom: 3px solid #ffffff; border-left: 3px solid #ffffff; border-right: 3px solid #ffffff" colspan=2 align="center" valign=middle bgcolor="#F1F5F9"><i><font size=3><?php  if(isset($grupo2)) echo $grupo2; ?><br></font></i></td>
		<td style="border-top: 3px solid #ffffff; border-bottom: 3px solid #ffffff; border-left: 3px solid #ffffff; border-right: 3px solid #ffffff" colspan=2 align="center" valign=middle bgcolor="#F1F5F9"><i><font size=3><?php  if(isset($grupo3)) echo $grupo3; ?><br></font></i></td>
		<td style="border-top: 3px solid #ffffff; border-bottom: 3px solid #ffffff; border-left: 3px solid #ffffff; border-right: 3px solid #ffffff" colspan=2 align="center" valign=middle bgcolor="#F1F5F9"><i><font size=3><?php  if(isset($grupo4)) echo $grupo4; ?><br></font></i></td>
...
<!--Proceso EA -->
	...
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=6 align="center" valign=middle><b><font size=1 color="#000000"><br><?php print_r($htp); ?></font></b></td>
...
<!-- Firmas  finales-->
	...
	<tr>
		<td height="31" align="left" colspan="9" valign=middle><br></td>
	...
	<tr>
		...
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td colspan=9 rowspan=2 align="center" valign=middle bgcolor="#F1F5F9">Firma<br></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
	...
	<tr>
		...
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td colspan=9 align="center" valign=middle bgcolor="#F1F5F9"><i><?php echo $nombre ?><br></i></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
		<td align="center" valign=middle><b><br></b></td>
	...
	<tr>
		<td height="24" align="left" valign=middle><br></td>
		<td align="center" valign=middle><br></td>
		<td colspan=10 align="center" valign=middle bgcolor="#F1F5F9"><i>Nombre<font color="#000000"><br></font></i></td>
		<td align="left" valign=middle><br></td>
		<td align="center" valign=middle><br></td>
		<td align="center" valign=middle><br></td>
		<td align="center" valign=middle><br></td>
